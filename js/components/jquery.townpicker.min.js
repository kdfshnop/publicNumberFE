...
(function ($) {
    ...
    $.fn.townpicker.addEventListeners = function () {
        ...
        $(".town-picker>.town>li").off("click").click(function () {
            $(this).toggleClass("on");
            if ($(this).hasClass("on")) $(this).find(".iconfont").removeClass("icon-teseweixuan").addClass("icon-teseyixuan");else $(this).find(".iconfont").removeClass("icon-teseyixuan").addClass("icon-teseweixuan");
        });
    };
    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    打开板块选择器
...
//# sourceMappingURL=jquery.townpicker.min.js.map
